...
extern void sendImagePathList(void* paths);
extern void* arkts_call_kotlin_cstr(libkn_KInt input);
extern void arkts_free_cstr(void* ptr);
extern void register_kotlin_call_arkts_controller(void* controller);
extern void sendBoxImagePath(void* path);
extern void* MainArkUIViewController(void* env);
extern void initResourceManager(void* resourceManager);
    ...
    struct {
      struct {
        struct {
          struct {
            struct {
              void (*runCrashGuarded)(const char* tag, libkn_KBoolean rethrow, libkn_kref_kotlin_Function0 block);
            } global;
            struct {
              struct {
                void (*sendImagePathList_)(void* paths);
                void* (*arkts_call_kotlin_cstr_)(libkn_KInt input);
                void (*arkts_free_cstr_)(void* ptr);
              } utils;
              libkn_KInt (*com_example_cmp_hello_sample_Outer_Nested$stableprop_getter)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Error$stableprop_getter)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Loading$stableprop_getter)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Success$stableprop_getter)();
              libkn_KInt (*com_example_cmp_hello_sample_Outer_Nested$stableprop_getter_)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Error$stableprop_getter_)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Loading$stableprop_getter_)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Success$stableprop_getter_)();
              libkn_KInt (*com_example_cmp_hello_sample_Outer_Nested$stableprop_getter__)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Error$stableprop_getter__)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Loading$stableprop_getter__)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Success$stableprop_getter__)();
              libkn_KInt (*com_example_cmp_hello_sample_Outer_Nested$stableprop_getter___)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Error$stableprop_getter___)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Loading$stableprop_getter___)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Success$stableprop_getter___)();
              libkn_KInt (*com_example_cmp_hello_sample_Outer_Nested$stableprop_getter____)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Error$stableprop_getter____)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Loading$stableprop_getter____)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Success$stableprop_getter____)();
              libkn_KInt (*com_example_cmp_hello_sample_Outer_Nested$stableprop_getter_____)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Error$stableprop_getter_____)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Loading$stableprop_getter_____)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Success$stableprop_getter_____)();
              libkn_KInt (*com_example_cmp_hello_sample_Outer_Nested$stableprop_getter______)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Error$stableprop_getter______)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Loading$stableprop_getter______)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Success$stableprop_getter______)();
              libkn_KInt (*com_example_cmp_hello_sample_Outer_Nested$stableprop_getter_______)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Error$stableprop_getter_______)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Loading$stableprop_getter_______)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Success$stableprop_getter_______)();
              libkn_KInt (*com_example_cmp_hello_sample_Outer_Nested$stableprop_getter________)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Error$stableprop_getter________)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Loading$stableprop_getter________)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Success$stableprop_getter________)();
              void (*registerKotlinCallArkTsController)(void* controller);
              libkn_KInt (*com_example_cmp_hello_sample_Outer_Nested$stableprop_getter_________)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Error$stableprop_getter_________)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Loading$stableprop_getter_________)();
              libkn_KInt (*com_example_cmp_hello_sample_Result_Success$stableprop_getter_________)();
              void (*sendBoxImagePath_)(void* path);
            } sample;
            void* (*get_nativeResourceManager)();
            void (*set_nativeResourceManager)(void* set);
            void* (*MainArkUIViewController_)(void* env);
            void (*initResourceManager_)(void* resourceManager);
          } cmp_hello;
        } example;
      } com;
      struct {
